...
<section id="main-content">
                        ...
                        <!-- ******************************pagination**************************************** -->    
                              <div class="rs-select2--light rs-select2--md"  onChange="pagination1()">  
                                            ...
                                            <select class="js-select2" name="" id="pagination1" >
                                                <option selected="selected" value="0">Proces</option>
  ...
  <% 	for (Map.Entry<String, Proces> e : map.entrySet()){
                          		...
                          		%>         <% if(request.getParameter("idDos") == null && request.getParameter("idProc")==null){%>     
                                            <tr class="tr-shadow trowM trow">
                                                <%}else{%><tr class="tr-shadow trowM trow" style="visibility: collapse;"><%} %>
                                                <td>
