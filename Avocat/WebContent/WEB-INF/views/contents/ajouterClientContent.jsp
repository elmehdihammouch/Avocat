    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="col-xs-4 col-xs-offset-1 input-effect herite mg">
        	<input class="effect-16 " type="text" placeholder="" id="nom" name="nomAC">
            <label>NOM</label>
            <span class="focus-border"></span>
        </div>
        <div class="col-xs-4 col-xs-offset-1 input-effect herite mg">
        	<input class="effect-16 " type="text" placeholder="" id="prenom" name="prenomAC">
            <label>Prenom</label>
            <span class="focus-border"></span>  
        </div>
        <div class="col-xs-12">
        ...
        <div class="col-xs-4 col-xs-offset-1 input-effect herite mg">
        	<input class="effect-16 " type="text" placeholder="" id="email" name="emailAC">
            <label>Email</label>
            <span class="focus-border"></span>
        </div>
        <div class="col-xs-4 col-xs-offset-1 input-effect herite mg">
        	<input class="effect-16"  type="text" placeholder="" id="telephone" name="phoneAC">
        ...
        <div class="col-xs-4 col-xs-offset-1 input-effect herite mg">
        	<input class="effect-16" type="text" placeholder="" id="dateNais" name="dateNaissanceAC">
            <label>Date de naissance</label>
            <span class="focus-border"></span>
        </div>
        <div class="col-xs-4 col-xs-offset-1 input-effect herite mg">
        	<input class="effect-16"  type="text" placeholder="" id="lieuNais" name="lieuNaissanceAC">
        ...
        <div class="col-xs-4 col-xs-offset-1 input-effect herite mg">
        	<input class="effect-16" type="text" placeholder="" id="adresse" name="adresseAC">
            <label>Adresse</label>
            <span class="focus-border"></span>      
        </div>
        <div class="col-xs-4 col-xs-offset-1 input-effect herite mg">
        	<input class="effect-16" type="text" placeholder="" id="municipale" name="municipaleAC">
