...
<title>Archive proces</title>
	<link rel="icon" href="./resources/media/images/icon.JPG">
	 <link href="./resources/css/contents/procesArchive.css" rel="stylesheet">
...
<jsp:include page="../contents/procesArchiveContent.jsp"></jsp:include>
