...
<% HttpSession ses = request.getSession();
	...
	<jsp:include page="../components/affiche.jsp"></jsp:include>
	</section>
	<%}else{%>
	<jsp:include page="../components/afficherprocesclient.jsp"></jsp:include>
    ...
    <script type="text/javascript" src="./resources/js/contents/accueilclient.js"></script>
</html>