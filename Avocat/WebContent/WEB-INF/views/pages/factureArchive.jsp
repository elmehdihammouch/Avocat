...
<title>Archive facture</title>
	<link rel="icon" href="./resources/media/images/icon.JPG">
	 <link href="./resources/css/contents/factureArchive.css" rel="stylesheet">
...
<jsp:include page="../contents/factureArchiveContent.jsp"></jsp:include>
   ...
   <!--------------------->
    <script type="text/javascript" src="./resources/js/contents/factureArchive.js"></script>
